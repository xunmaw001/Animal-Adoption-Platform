        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物性别" prop="sexTypes">
                        <el-select v-model="ruleForm.sexTypes" :disabled="ro.sexTypes" placeholder="请选择宠物性别">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="宠物年龄" prop="chongwuAge">
                       <el-input v-model="ruleForm.chongwuAge"
                                 placeholder="宠物年龄" clearable  :readonly="ro.chongwuAge"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="领养状态" prop="zhuangtiaTypes">
                        <el-select v-model="ruleForm.zhuangtiaTypes" :disabled="ro.zhuangtiaTypes" placeholder="请选择领养状态">
                            <el-option
                                v-for="(item,index) in zhuangtiaTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhuangtia_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhuangtiaTypesOptions = data.data.list;
                    }
                });
