    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(chongwuyongpinCommentback !=null){
            ...
            BeanUtils.copyProperties( chongwuyongpin , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "username", "password", "newMoney", "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
...
//        else if("用户".equals(role))
//            chongwuyongpinCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(chongwuyongpinCommentback.getChongwuyongpinCommentbackText()) || "null".equals(chongwuyongpinCommentback.getChongwuyongpinCommentbackText())){
                chongwuyongpinCommentback.setChongwuyongpinCommentbackText(null);
        }
        if("".equals(chongwuyongpinCommentback.getReplyText()) || "null".equals(chongwuyongpinCommentback.getReplyText())){
                chongwuyongpinCommentback.setReplyText(null);
        }
        ...
        ChongwuyongpinCommentbackEntity chongwuyongpinCommentback = chongwuyongpinCommentbackService.selectById(id);
            if(chongwuyongpinCommentback !=null){
                ...
                //级联表
                    ChongwuyongpinEntity chongwuyongpin = chongwuyongpinService.selectById(chongwuyongpinCommentback.getChongwuyongpinId());
                if(chongwuyongpin != null){
                    BeanUtils.copyProperties( chongwuyongpin , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "username", "password", "newMoney", "yonghuId"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setChongwuyongpinId(chongwuyongpin.getId());
                }
                //级联表
                    YonghuEntity yonghu = yonghuService.selectById(chongwuyongpinCommentback.getYonghuId());
