        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '宠物性别' : ''">
                        <el-select v-model="searchForm.sexTypes" placeholder="请选择宠物性别">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '领养状态' : ''">
                        <el-select v-model="searchForm.zhuangtiaTypes" placeholder="请选择领养状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                               v-for="(item,index) in zhuangtiaTypesSelectSearch"
                               v-bind:key="index"
                               :label="item.indexName"
                               :value="item.codeIndex">
                            <!--lable是要展示的名称-->
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/dongwulingyangpingtai/upload/chongwuMuBan.xls"
                        >批量导入宠物信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('chongwu','导入导出')"
