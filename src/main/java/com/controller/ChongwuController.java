...
//                            chongwuEntity.setSexTypes(Integer.valueOf(data.get(0)));   //宠物性别 要改的
...
//                            chongwuEntity.setChongwuClicknum(Integer.valueOf(data.get(0)));   //点击量 要改的
//                            chongwuEntity.setChongwuContent("");//详情和图片
//                            chongwuEntity.setZhuangtiaTypes(Integer.valueOf(data.get(0)));   //领养状态 要改的
