...
//            return R.error(511,"永远不会进入");
        ...
        if("".equals(chongwuyongpin.getChongwuyongpinContent()) || "null".equals(chongwuyongpin.getChongwuyongpinContent())){
                chongwuyongpin.setChongwuyongpinContent(null);
        }
...
//                            chongwuyongpinEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R gexingtuijian(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        params1.put("chongwuyongpinYesnoTypes",2);
        ...
        for(Integer type:typeList){
            ...
            params2.put("chongwuyongpinYesnoTypes",2);
        ...
        params.put("chongwuyongpinYesnoTypes",2);
