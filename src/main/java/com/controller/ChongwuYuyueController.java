...
//        else if("用户".equals(role))
//            chongwuYuyue.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(chongwuYuyue.getChongwuYuyueText()) || "null".equals(chongwuYuyue.getChongwuYuyueText())){
                chongwuYuyue.setChongwuYuyueText(null);
        }
        if("".equals(chongwuYuyue.getChongwuYuyueYesnoText()) || "null".equals(chongwuYuyue.getChongwuYuyueYesnoText())){
                chongwuYuyue.setChongwuYuyueYesnoText(null);
        }
    ...
    */
    ...
    public R shenhe(@RequestBody ChongwuYuyueEntity chongwuYuyueEntity, HttpServletRequest request){
        ...
        if(chongwuYuyueEntity.getChongwuYuyueYesnoTypes() == 2){//通过
            ...
            chongwuEntity.setZhuangtiaTypes(2);
...
//                            chongwuYuyueEntity.setChongwuYuyueText(data.get(0));                    //领养缘由 要改的
//                            chongwuYuyueEntity.setInsertTime(date);//时间
//                            chongwuYuyueEntity.setChongwuYuyueYesnoTypes(Integer.valueOf(data.get(0)));   //申请状态 要改的
