  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yuangong'"  label='员工名称' prop="yuangongName">
               <el-input v-model="ruleForm.yuangongName"  placeholder='员工名称' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yuangong'" label='员工图片' prop="yuangongPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yuangong'"  label='员工部门' prop="yuangongTypes">
                 <el-select v-model="ruleForm.yuangongTypes"  placeholder='请选择员工部门'>
                     <el-option
...
// 注册表 员工 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yuangongTypes)&& 'yuangong'==this.flag){
