    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宠物性别" prop="sexValue">
                        <el-input v-model="chongwuForm.sexValue"
                                  placeholder="宠物性别" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="宠物性别" prop="sexValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宠物年龄" prop="chongwuAge">
                        <el-input v-model="chongwuForm.chongwuAge"
                                  placeholder="宠物年龄" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="宠物年龄" prop="chongwuAge">
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击量" prop="chongwuClicknum">
                        <el-input v-model="chongwuForm.chongwuClicknum"
                                  placeholder="点击量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="点击量" prop="chongwuClicknum">
                            <el-input v-model="ruleForm.chongwuClicknum"
                                      placeholder="点击量" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="领养状态" prop="zhuangtiaValue">
                        <el-input v-model="chongwuForm.zhuangtiaValue"
                                  placeholder="领养状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="领养状态" prop="zhuangtiaValue">
                            <el-input v-model="ruleForm.zhuangtiaValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="领养缘由" prop="chongwuYuyueText">
                        <el-input type="textarea"  :readonly="ro.chongwuYuyueText" v-model="ruleForm.chongwuYuyueText" placeholder="领养缘由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chongwuYuyueText" label="领养缘由" prop="chongwuYuyueText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chongwuYuyueYesnoTypes" label="申请状态" prop="chongwuYuyueYesnoTypes">
                        <el-input v-model="ruleForm.chongwuYuyueYesnoValue" placeholder="申请状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
