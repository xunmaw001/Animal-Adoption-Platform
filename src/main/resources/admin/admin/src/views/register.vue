    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">动物领养平台注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <el-form-item label="员工名称" class="input" v-if="tableName=='yuangong'">
                            <el-input v-model="ruleForm.yuangongName" autocomplete="off" placeholder="员工名称"  />
                        </el-form-item>
                        ...
                        <!--
                            ...
                            <el-form-item label="员工图片" class="input" v-if="tableName=='yuangong'">
                                    <file-upload
                                        tip="点击上传员工图片"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                       <!--<el-form-item class="input" label="员工部门">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.yuangongTypes" placeholder="请选择员工部门">
                                <el-option
                                        v-for="(item,index) in yuangongTypesOptions"
                        ...
                        <!--
                            <el-form-item label="逻辑删除" class="input" v-if="tableName=='yuangong'">
                                <el-input v-model="ruleForm.yuangongDelete" autocomplete="off" placeholder="逻辑删除"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yuangong 中的 员工图片 判空处理
                            // if('yuangong' == this.tableName && (this.ruleForm.yuangongPhoto== null ||this.ruleForm.yuangongPhoto== "")){
                            //     this.$message.error("员工图片不能为空");
                            //     return
                            // }
                            // yuangong 中的 员工部门 判空处理
                            // if('yuangong' == this.tableName && (this.ruleForm.yuangongTypes== null ||this.ruleForm.yuangongTypes== "")){
                            //     this.$message.error("员工部门不能为空");
                            //     return
                            // }
                            // yuangong 中的 逻辑删除 判空处理
                            // if('yuangong' == this.tableName && (this.ruleForm.yuangongDelete== null ||this.ruleForm.yuangongDelete== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/dongwulingyangpingtai/img/back-img-bg.jpg);
