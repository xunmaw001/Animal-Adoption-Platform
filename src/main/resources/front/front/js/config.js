...
var centerMenu = [
    ...
    ,{
        name: '商品评价',
        url: '../chongwuyongpinCommentback/list.html'
    }
    ,{
        name: '商品订单',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/dongwulingyangpingtai/admin/dist/index.html#/login";
